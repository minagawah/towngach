...
/**
 * Returns the sexagenary day using the repository's UTC date adapter.
 * 2000-01-07 is the implementation reference treated as 甲子.
 * @param {*} date
 * @returns {Object}
 */
...
/**
 * Returns the traditional double-hour branch. 子時 begins at 23:00.
 * @param {*} date
 * @returns {Branch}
 */
...
/**
 * Determines the latest supported Yin/Yang Dun boundary.
 * @param {*} date
 * @returns {Object}
 */
...
/**
 * Classifies an hourly branch into the confirmed Three Yuan groups.
 * @param {Branch} branch
 * @returns {string}
 */
...
/**
 * Returns the confirmed hourly origin star.
 * @param {string} dun
...
/**
 * Determines the latest 甲己-day 子-hour origin without selecting a
 * future boundary or using an arbitrary search window.
 * @param {*} date
 * @returns {Object}
 */
...
/**
 * Creates the shared Purple-White flight result.
...
/**
 * Determines the active actual solar-term boundary for monthly logic.
 * @param {*} date
 * @returns {Object}
 */

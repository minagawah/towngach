...
Japanese systems of **"directional divination"** (方鑑 / 方鉴 / phương giám), for which **"Ojima Sekibun"** (尾島碩聞) or **"Matsuura Kinkaku"** (松浦琴鶴) are commonly known, adopted and reorganized purple-white (紫白) calculations within their own calendrical and practical traditions. Annual, monthly, daily, and hourly stars continued to be calculated through the **"nine-palaces"** (九宮) where the **"sixty-unit-cycle (sexagenary)"** (六十干支 / 六十花甲 / lục thập hoa giáp) and **"three-epoch"** (三元) structures remained particularly important.
